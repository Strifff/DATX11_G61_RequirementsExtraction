...
# load docs_and_pages
current_pages = {
    "ISO_8528_8_2016_EN": [9, 10],
    "SS_EN_60871_1_EN": [35, 36, 37],
    "IEC_IEEE_60214": [45, 46],
}
...
order = list(filter(lambda x: x[1]["page"] in current_pages[x[1]["doc"]], order))
order = list(map(lambda x: (x[0] + 200, x[1]), order))
...
print(f"Distinct docs and pages for rater {rater}")
